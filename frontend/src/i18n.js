...
const translations = {
  id: {
    ...
    "audit.target": "Target",
    "audit.reason": "Alasan",
    "audit.filterActorPlaceholder": "ID pengguna...",
    "audit.filterActionPlaceholder": "cth. users.access.update",
    "audit.filterTargetPlaceholder": "cth. user, order",
    "audit.noMatch": "Tidak ada audit event yang cocok dengan filter.",
  ...
  en: {
    ...
    "audit.target": "Target",
    "audit.reason": "Reason",
    "audit.filterActorPlaceholder": "User ID...",
    "audit.filterActionPlaceholder": "e.g. users.access.update",
    "audit.filterTargetPlaceholder": "e.g. user, order",
    "audit.noMatch": "No audit events match the current filters.",
