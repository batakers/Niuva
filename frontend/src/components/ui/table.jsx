...
const TableHeader = React.forwardRef(({ className, ...props }, ref) => (
  <thead 
    ref={ref} 
    className={cn(
      "[&_tr]:border-b [&_tr]:border-border-default [&_tr]:bg-surface-muted/50",
      className
    )} 
    {...props} 
  />
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      "data-[state=selected]:bg-action-primary/5",
      className
    )}
    {...props} />
))
...
const TableHead = React.forwardRef(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-3 text-left align-middle font-mono text-[11px] font-semibold uppercase tracking-wider text-text-secondary",
