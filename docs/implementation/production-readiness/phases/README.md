...
Tracker vocabulary is deliberately multidimensional: `source_complete` means
the bounded source exists; `verified_locally` means named local or isolated-CI
checks passed; `environment_blocked` means required deployed/provider/data or
operational proof is absent; and `production_ready` requires a separate,
explicit production-candidate decision. The first two never imply the fourth.
Numeric audit scores remain bound to the SHA named by their audit packet.

| Feature | Evidence packets | PR state | Tracker status |
| --- | --- | --- | --- |
| Tracker and Governance Reconciliation | [reconciliation packet](TRACKER-GOVERNANCE-RECONCILIATION-2026-08-14.md); [audit progress](../../../context/production-readiness-audit/AUDIT_PROGRESS.md) | Stacked documentation branch; PR pending behind #251 | PR #226 confirmed merged as `72018ce`; #244–#251 recorded as a non-scoring overlay. Source, local verification, environment blockers, and production readiness are separated; no score is carried beyond its named SHA. |
| Runtime Reliability Current-Main Audit | [task card](RUNTIME-RELIABILITY-CURRENT-MAIN-2026-08-14-task-card.md); [revalidation](RUNTIME-RELIABILITY-CURRENT-MAIN-REVALIDATION-2026-08-14.md) | PR #251 open, stacked behind #250 | Liveness, required-dependency readiness, storage/email boundaries, notification claim/lease/retry/exhaustion, graceful drain, structured-log redaction, bounded resources, schema/index/pagination, and the GET-only load probe revalidated at runtime `15b759a`; focused local matrix `223 passed`. External provider/topology, telemetry delivery, owned SLO/on-call, representative capacity, deployment, and production gates remain open. |
| Test and Quality Evidence Current-Main Audit | [task card](QUALITY-EVIDENCE-CURRENT-MAIN-2026-08-14-task-card.md); [revalidation](QUALITY-EVIDENCE-CURRENT-MAIN-REVALIDATION-2026-08-14.md) | PR #250 open, stacked behind #249 | Hermetic and dependency evidence revalidated; collector is constrained to 169 tracked Python files and empty JUnit is fail-closed. Local full suite passed `1036` with 15 declared skips. Real-transaction exact-head CI, external targets, Admin browser artifact/checksum enforcement, whole-tree thresholds, Motor migration, legal disposition, production-like evidence, and release gates remain open. |
| File Security and Storage Current-Main Audit | [task card](FILE-STORAGE-CURRENT-MAIN-2026-08-14-task-card.md); [revalidation](FILE-STORAGE-CURRENT-MAIN-REVALIDATION-2026-08-14.md) | PR #249 open, stacked behind #248 | Object/owner/domain authorization, signature/MIME, bounded streaming/size, inactive-state/publication denial, compensation, logical-path compatibility, and historical payment-proof custody revalidated at runtime `15b759a`; focused matrix `101 passed`. Provider, scanner, retention/quota, RPO/RTO, backup/restore, historical reconciliation, deployment, and production gates remain blocked. |
| Commerce Lifecycle Current-Main Audit | [task card](COMMERCE-LIFECYCLE-CURRENT-MAIN-2026-08-14-task-card.md); [revalidation](COMMERCE-LIFECYCLE-CURRENT-MAIN-REVALIDATION-2026-08-14.md) | PR #248 open, stacked behind #247 | Inquiry, Quote, Project Conversion, Work Order, and inactive Retail 3.4A contracts revalidated at runtime baseline `15b759a`; focused matrix `161 passed, 1` explicit real-transaction skip. Organization Portal, historical reconciliation, active Retail/payment/fulfilment, representative data, external, deployment, and production gates remain open. |
| API, OpenAPI, and Compatibility Current-Main Audit | [task card](API-CONTRACT-CURRENT-MAIN-2026-08-14-task-card.md); [revalidation](API-CONTRACT-CURRENT-MAIN-REVALIDATION-2026-08-14.md); [compatibility register](FEATURE-8.3-compatibility-endpoint-register.md) | PR #247 open, stacked behind #246 | All 152 operations and 21 compatibility endpoints revalidated at runtime baseline `15b759a`. Whole-API response/error/security, 15 idempotency-conflict declarations, broad pagination/date contracts, external consumers, and endpoint-specific retirement evidence remain open. |
| Database, Migration, and Data Integrity Current-Main Audit | [task card](MIGRATION-DATA-INTEGRITY-CURRENT-MAIN-2026-08-14-task-card.md); [revalidation](MIGRATION-DATA-INTEGRITY-CURRENT-MAIN-REVALIDATION-2026-08-14.md) | PR #246 open, stacked behind #245 | Migration 001–010 and historical reconciliation controls revalidated at runtime baseline `15b759a`. Migration 001/004/005/007 remain hard stops; 006 real-account apply, 007–010 representative rehearsal, Quote-line/notification report execution, and legacy Order/file reconciliation remain separately gated. |
| 1.x / 2.1 Current-Main Auth, Authorization, and Privacy | [task card](AUTH-SECURITY-CURRENT-MAIN-2026-08-14-task-card.md); [revalidation](AUTH-SECURITY-CURRENT-MAIN-REVALIDATION-2026-08-14.md) | PR #245 open, stacked behind #244 | Runtime `15b759a` revalidated; all 112 effective Admin routes now have inventory-driven negative permission enforcement. NIV-001, DR-004, DR-005, key/retention operations, migrations, external topology, independent verification, deployment, and go-live remain open. |
...
| 2.4 File Authorization and Security | [remediation](FEATURE-2.4-file-security-remediation.md); [current-main storage revalidation](FILE-STORAGE-CURRENT-MAIN-REVALIDATION-2026-08-14.md) | #93 merged as `57de1f3`; current-main audit PR #249 open | Bounded local/CI hardening is merged and revalidated at `15b759a` with `101` focused passes. Production provider/scanner, retention/quota, backup/restore, owners, historical proof/object reconciliation, deployment, and go-live remain open. |
