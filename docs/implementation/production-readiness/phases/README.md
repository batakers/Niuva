...
| 5.1 CMS Publication Lifecycle | [remediation](FEATURE-5.1-cms-publication-remediation.md) | PR #99 open on `fix/backend-cms-publication` | Concurrent publish/rollback conflicts and audit-failure atomicity are covered by real replica-set tests; timezone and permission contracts are covered locally. Migration 007, production topology, deployment, and broader DR-010 consumer decisions remain open. |
