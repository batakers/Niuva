...
| --- | --- | --- | --- |
| API, OpenAPI, and Compatibility Current-Main Audit | [task card](API-CONTRACT-CURRENT-MAIN-2026-08-14-task-card.md); [revalidation](API-CONTRACT-CURRENT-MAIN-REVALIDATION-2026-08-14.md); [compatibility register](FEATURE-8.3-compatibility-endpoint-register.md) | Stacked feature branch; PR pending behind #246 | All 152 operations and 21 compatibility endpoints revalidated at runtime baseline `15b759a`. Whole-API response/error/security, 15 idempotency-conflict declarations, broad pagination/date contracts, external consumers, and endpoint-specific retirement evidence remain open. |
