...
| 2.4 File Authorization and Security | [remediation](FEATURE-2.4-file-security-remediation.md); [current-main storage revalidation](FILE-STORAGE-CURRENT-MAIN-REVALIDATION-2026-08-14.md) | #93 merged as `57de1f3`; current-main audit PR #249 merged as `59aa1a0` | Bounded local/CI hardening is merged and revalidated at `15b759a` with `101` focused passes. Production provider/scanner, retention/quota, backup/restore, owners, historical proof/object reconciliation, deployment, and go-live remain open. |
