...
| Admin session, MFA, and access-review boundary | `FE-002`, `INT-004`, `SEC-002`, `SEC-003`, `SEC-007` | 01, 05, 06 | Legacy Admin bearer/session behavior and incomplete internal access controls conflict with approved auth direction. | P1 | Admin Session local revalidation merged in PR #80; Feature 1.6 in PR #86 confirms MFA is absent and decision-blocked; access-review and production acceptance remain `requires_revalidation` / blocked | 94-100% | Yes | Yes | Decide the cross-tab policy; complete DR-005 TOTP, encryption/key, enrollment, pre-auth/session, step-up, recovery, event, owner, and rollout contracts; retain exact-target HTTPS/proxy, migration/cutover, and production gates. | `DEC-AUTH-005/007/008/009`; [Feature 1.2 evidence](phases/FEATURE-1.2-admin-session-revalidation.md); [Feature 1.6 evidence](phases/FEATURE-1.6-internal-mfa-revalidation.md); identity and operations owners; Migration 009; browser and production evidence. |
