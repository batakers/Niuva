...
| DR-003 | Confirm the bounded Admin auth recovery/session scope on the selected baseline. | Newer default-branch Phase 1/2 work is evidence of change, not closure of the audit snapshot. | Auth implementation planning and Phase 1 exit. | DEC-AUTH-003/004/005; recovery/session packets and runbooks; selected-SHA tests. | Security/identity owner; explicit included/excluded scope and rollout boundary. | Existing packets are limited; roadmap-wide decision remains open. |
