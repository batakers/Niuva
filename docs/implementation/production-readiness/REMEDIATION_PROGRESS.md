...
| 3 - Backend Business Logic and API Contracts | HTTP envelope, lifecycle, readiness, notification, compatibility/CMS | API transport; notification; CMS/Portfolio; governance/compatibility | `requires_revalidation` — Feature 5.1 closes the verified CMS concurrency error seam; Feature 8.3 completes a current-main planning inventory of 21 compatibility endpoint candidates, but no route retirement or sunset implementation is authorized | Existing merged slices and bounded Feature 5.1 authority; Feature 8.3 is documentation/governance planning only | [PHASE-03A HTTP/command plan](phases/PHASE-03A-http-command-contract-plan.md); [Feature 5.1 evidence](phases/FEATURE-5.1-cms-publication-remediation.md); [Feature 8.3 register](phases/FEATURE-8.3-compatibility-endpoint-register.md) | Feature 8.3 PR #111 on `plan/backend-compatibility-endpoints`; PR #99 retains its recorded state | Feature 8.3 documentation `6bc9d89`; reconciled through `fe1d8a0`; selected RC remains `d04e3f0` | OpenAPI reconciliation found 151 operations and 21 candidates: 13 retained, 5 retired tombstones, 1 deprecated alias, and 2 requiring clarification. Focused backend compatibility passed 70 tests; full backend passed 667 tests with 14 skips and 14 subtests; full frontend passed 36 suites and 239 tests; build passed. A 3 August reconciliation check retained 151 unique operations and unchanged dispositions after PR #101 merged. No deployed-runtime, external-consumer, data-operation, release, or production evidence is implied. | 2026-08-03 | PR #111 reconciliation review is complete and merge is authorized; require green current-head CI. Decide Legacy Contact and stale Material DELETE sunset handling before any source task. Refresh after PR #106/#109/#110 merge or close; retain migration, release, and production gates. |
