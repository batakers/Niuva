...
| 1 - Identity, Authentication, Authorization, and Privacy | Auth, role, privacy, file/order boundaries, transaction/payment guard | Session/MFA; recovery; abuse; file/order; transaction; quote; payment; Admin parity | `requires_revalidation` — PHASE-01A Feature 1.1–1.3 source/local-evidence packets merged through PRs #79–#81 and PHASE-01B selected-SHA evidence passed; independent review and broader decision/environment gates remain | `blocked_by_decision` | [Phase evidence index](phases/README.md); each packet retains its own boundary | PRs #79–#81 for PHASE-01A; PHASE-01B remains separate | `b69fbb54871774a105ee8dc1d785596ebb6f9692` | Customer Session remediation, Admin Session revalidation, and Password Recovery remediation evidence entered `main`; PHASE-01B candidate `9ef645a` retains its direct backend/frontend matrix. No application migration, real provider delivery, deployed-origin, or production acceptance was proven. | 2026-07-29 | Resolve the recorded Feature 1.1–1.3 migration/production/cross-tab/timing/provider gaps, obtain independent PHASE-01B review, and keep 01D plus broader Phase 1 blocked until DR-004/005 and required environment evidence exist. |
...
| `PHASE-01A`–`PHASE-05D` | PHASE-01A now records merged Feature 1.1 Customer Session remediation, Feature 1.2 Admin Session revalidation, and Feature 1.3 Password Recovery remediation evidence from PRs #79–#81. PHASE-01B has selected-SHA backend/frontend direct-access evidence on `9ef645a`; broader scope remains `blocked_by_decision` or `requires_revalidation`. | Close or explicitly disposition the feature-specific open gates below, obtain independent PHASE-01B review, then record DR-004 through DR-010 as applicable. |
...
### Merged Feature 1.1–1.3 evidence update
...
authorized separately by `DEC-AUTH-010`. The three latest merged pull requests
extend the bounded PHASE-01A evidence record as follows:
...
They do not complete roadmap-wide PHASE-01A, resolve grouped MFA/access-review
