...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 0 - Safety, Baseline, and Evidence Preservation | RC baseline, NIV-001, migration stop conditions, provenance | Freshness; NIV-001; migration/live-schema; governance/provenance | `planning` — PHASE-00A review passed; PHASE-00D is ready for independent review; remaining Phase 0 scope is gated | Planning/evidence only; broader Phase 0 remains `blocked_by_decision` | [REMEDIATION_ROADMAP.md](REMEDIATION_ROADMAP.md) | Not selected | `d04e3f009d6c815c0a4d99dfa5c93553da3cef43` | Git ancestry and 240-path changed-scope map recorded; no finding closure evidence | 2026-07-29 | Review PHASE-00D disposition. Appoint the NIV-001 independent verifier before PHASE-00B; complete remaining DR-012 target/topology/RPO-RTO/evidence fields before PHASE-00C execution. |
| 1 - Identity, Authentication, Authorization, and Privacy | Auth, role, privacy, file/order boundaries, transaction/payment guard | Session/MFA; recovery; abuse; file/order; transaction; quote; payment; Admin parity | `requires_revalidation` — `DEC-DATA-002` and `DEC-ACCESS-003` recorded; independent review and broader gates remain | `blocked_by_decision` | Roadmap only; existing auth packets retain their own gates | Not selected for roadmap | `d04e3f009d6c815c0a4d99dfa5c93553da3cef43` | Targeted backend, replica-set, HTTP, frontend-state, and disposable same-origin HTTPS browser login/reload evidence passed within DR-003 scope; current B2B source retains exact Quote-line identity and payment lockdown; legacy customer-safe projection requires selected-scope revalidation | 2026-07-29 | Open a bounded PHASE-01B projection/access revalidation task; keep 01D and broader Phase 1 blocked until DR-004/005 and environment evidence exist. |
