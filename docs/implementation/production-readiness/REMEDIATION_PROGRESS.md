...
| 1 - Identity, Authentication, Authorization, and Privacy | Auth, role, privacy, file/order boundaries, transaction/payment guard | Session/MFA; recovery; abuse; file/order; transaction; quote; payment; Admin parity | `requires_revalidation` — DR-006 quote-line policy recorded; independent review and broader gates remain | `blocked_by_decision` | Roadmap only; existing auth packets retain their own gates | Not selected for roadmap | `d04e3f009d6c815c0a4d99dfa5c93553da3cef43` | Targeted backend, replica-set, HTTP, frontend-state, and disposable same-origin HTTPS browser login/reload evidence passed within DR-003 scope; current B2B source retains exact Quote-line identity and payment lockdown | 2026-07-29 | Obtain independent review where available; keep 01B/01D and broader Phase 1 blocked until DR-004/005, DR-007, and environment evidence exist. |
